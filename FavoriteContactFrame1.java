...
public class FavoriteContactFrame extends JPanel{
	...
	private static HashMap<String, FavoriteContactFrame> contactFrameMap = new HashMap<>();
	
	
	
	public static HashMap<String, FavoriteContactFrame> getHashMap() {
		
		return contactFrameMap;
	}
	/**
